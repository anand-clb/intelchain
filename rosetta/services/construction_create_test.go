...
func TestRecoverSenderAddressFromCollectRewardsString(t *testing.T) {
	...
	_, tx, rosettaError := unpackWrappedTransactionFromString("{\"rlp_bytes\":\"4wTVlOvNFujB2PSTugTpmlZHQSLYGpxYgIR3NZQAglIIgICA\",\"is_staking\":true,\"contract_code\":\"0x\",\"from\":{\"address\":\"itc13lx3exmpfc446vsguc5d0mtgha2ff7h5uz85pk\",\"metadata\":{\"hex_address\":\"0x8fCD1C9B614E2b5D3208E628d7eD68bF5494faF4\"}}}", false)
	if rosettaError != nil {
...
func stakingCreateValidatorTransaction(key *ecdsa.PrivateKey) (*stakingTypes.StakingTransaction, common2.Hash, error) {
	...
	copy(sig[:], sigg)
	validator, _ := common.Bech32ToAddress("itc1pdv9lrdwl0rg5vglh4xtyrv3wjk3wsqket7zxy")
...
func stakingEditValidatorTransaction(key *ecdsa.PrivateKey) (*stakingTypes.StakingTransaction, common2.Hash, error) {
	stakePayloadMaker := func() (stakingTypes.Directive, interface{}) {
		...
		validator, _ := common.Bech32ToAddress("itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9")
...
func stakingDelegateTransaction(key *ecdsa.PrivateKey) (*stakingTypes.StakingTransaction, common2.Hash, error) {
	stakePayloadMaker := func() (stakingTypes.Directive, interface{}) {
		...
		validator, _ := common.Bech32ToAddress("itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9")
		delegator, _ := common.Bech32ToAddress("itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9")
		return stakingTypes.DirectiveDelegate, stakingTypes.Delegate{
			ValidatorAddress: validator,
