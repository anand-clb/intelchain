...
func TestCreateValidatorOperationMetadata_UnmarshalFromInterface(t *testing.T) {
	data := map[string]interface{}{
		"validatorAddress":   "itc1pdv9lrdwl0rg5vglh4xtyrv3wjk3wsqket7zxy",
	...
	if s.ValidatorAddress != "itc1pdv9lrdwl0rg5vglh4xtyrv3wjk3wsqket7zxy" {
	...
	if s.Website != "alice.intelchain.org" {
...
func TestEditValidatorOperationMetadata_UnmarshalFromInterface(t *testing.T) {
	data := map[string]interface{}{
		"validatorAddress":   "itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9",
		"commissionRate":     100000000000000000,
		"minSelfDelegation":  10,
		"maxTotalDelegation": 3000,
		"name":               "Alice",
	...
	if s.ValidatorAddress != "itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9" {
		t.Fatal("wrong validator address")
	}
	if s.CommissionRate.Cmp(new(big.Int).SetInt64(100000000000000000)) != 0 {
		t.Fatal("wrong commission rate")
...
func TestDelegateOperationMetadata_UnmarshalFromInterface(t *testing.T) {
	data := map[string]interface{}{
		"validatorAddress": "itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9",
		"delegatorAddress": "itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9",
		"amount":           20000,
	}
	...
	if s.DelegatorAddress != "itc1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9" {
